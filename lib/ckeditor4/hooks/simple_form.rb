...
module Ckeditor4::Hooks::SimpleForm
  class CkeditorInput < ::SimpleForm::Inputs::Base
    def input(wrapper_options = nil)
      @builder.ck4_cktext_area(attribute_name, input_html_options)
    end
  end
end

::SimpleForm::FormBuilder.map_type :ckeditor, :to => Ckeditor4::Hooks::SimpleForm::CkeditorInput
